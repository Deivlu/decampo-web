...
const site = {
  ...
  address: "Ruta 5, Corrientes, Argentina",
  email: "",
  horario: "Lun a Sáb 9:00–19:00",
  mapEmbed:
    "https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3539.3491488263817!2d-58.730101000000005!3d-27.489515!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjfCsDI5JzIyLjMiUyA1OMKwNDMnNDguNCJX!5e0!3m2!1ses!2sar!4v1760047486030!5m2!1ses!2sar",
...
const productos = [
  ...
  {
    nombre: "Living/Camastros",
    desde: null,
    imgs: [
      "/images/Living/camastro1.jpg",
      "/images/Living/camastro2.jpg",
      "/images/Living/camastro3.jpg",
      "/images/Living/mesaratona1.JPG",
      "/images/Living/mesaratona2.JPG",
      "/images/Living/mesaratona3.JPG",
      "/images/Living/mesaratona4.JPG",
      "/images/Living/sillarustica1.JPG",
    ],
    tags: ["Descanso", "Exterior", "Living"],
  },
];
...
const diferenciales = [
  { title: "A medida", text: "Diseñamos según tu espacio y uso." },
  {
    ...
    text: "Timbó, lapacho, quebracho, urunday, etc.",
  },
  {
    title: "Acabado profesional",
    text: "Aceite, barniz o cetol con filtro UV.",
  },
...
const faq = [
  {
    ...
    a: "Sí. Adaptamos diseño, madera y terminación a tu espacio.",
  },
  {
  ...
  {
    q: "¿Plazos de fabricación?",
    a: "Entre 10 y 25 días según complejidad y volumen.",
  },
...
const WhatsAppButton = ({
  ...
  const iconColor =
    variant === "outlineLight" ? "text-neutral-900" : "text-white";
...
const SelloTripleCapa = ({ withText = false, className = "" }) => (
  ...
  >
    ...
    >
      ...
      <path
        d="M9.5 12.5l1.5 1.5 3.5-3.5 1.2 1.2-4.7 4.7-2.7-2.7 1.2-1.2z"
        fill="white"
      />
    </svg>
    TRIPLE CAPA
    {withText && (
      <span className="ml-2 text-[11px] font-normal text-white/95">
        Impregnante en tres manos sobre todos nuestros productos para evitar
        que, a futuro, vuelva a ingresar humedad dentro de la madera.
      </span>
    )}
  </span>
);
...
const Lightbox = ({ images = [], index = 0, onClose, setIndex }) => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 h-10 w-10 rounded-full bg-black/70 text-white grid place-items-center hover:bg-black"
        aria-label="Cerrar"
      >
        ✕
      </button>

      {/* Flecha izquierda (más visible y centrada) */}
      {images.length > 1 && (
        <button
          onClick={(e) => {
            e.stopPropagation();
          ...
          className="absolute left-4 top-1/2 -translate-y-1/2 z-20
                         h-12 w-12 rounded-full bg-black/70 text-white flex items-center justify-center
      ...
      {/* Flecha derecha (más visible y centrada) */}
      {images.length > 1 && (
        <button
          onClick={(e) => {
            e.stopPropagation();
      ...
      <div className="relative aspect-[4/3]">
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          {p.tags.map((t) => (
            <span
              key={t}
              className="text-xs bg-black/70 text-white px-2 py-1 rounded-full"
            >
              {t}
            </span>
          ))}
        ...
        {/* Flechas internas (siguen comentadas como tenías) */}
        {total > 1 && (
          <>
...
/* Carrusel horizontal del catálogo (flechas más visibles y bien ubicadas) */
    ...
    <div className="relative mt-8">
      ...
      <button
        ...
        className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-10
                       h-10 w-10 rounded-full bg-black/70 text-white justify-center items-center
                       hover:bg-black transition"
      >
        ‹
      </button>
    ...
    >
      ...
      >
        <div className="relative h-60 sm:h-72">
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 h-9 w-9 rounded-full grid place-items-center bg-black/60 text-white hover:bg-black"
            aria-label="Cerrar"
            title="Cerrar"
          >
            ✕
        ...
        <div className="p-6">
          ...
          <p className="text-neutral-700 mt-3 leading-relaxed whitespace-pre-line">
            {item.larga}
          </p>
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="text-sm mt-1">
          Aplicamos <strong>triple capa de impregnante</strong> en todos
          nuestros productos para <strong>bloquear la humedad</strong> y
...
export default function LandingDeCampoMuebles() {
  // (si no usás fade-in del hero, podés quitar estas 2 líneas)
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            kicker="Catálogo"
            title="Algunas de nuestras piezas"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border">
              ...
              <ol className="list-decimal pl-5 mt-3 space-y-2 text-neutral-700">
                <li>
                  <strong>Elegí el mueble</strong> que más te guste: mesa para
                  quincho, mesa ratona, isla de cocina/quincho, rack de TV,
                  juego de camastro para exterior, u otros.
                </li>
                <li>
                  <strong>Elegí la madera</strong>: Timbó, Urunday, Lapacho,
                  Pino-Misionero, Quebracho.
                </li>
                <li>
                  <strong>Indicá las medidas</strong>. Si no estás seguro, te
                  asesoramos sin cargo.
                </li>
                <li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border">
              ...
              <p className="text-neutral-700 mt-2">
                Seleccionamos tablas sanas y parejas, realizamos secado natural
                para eliminar humedad, cepillamos y pulimos para una textura
                suave, y protegemos con triple capa de impregnante para evitar
                reingreso de humedad.
              </p>

              <h4 className="font-semibold mt-4">Mantenimiento</h4>
              <p className="text-neutral-700 mt-1">
                Una vez recibido, sólo pasá un producto tipo <em>BLEM</em> con
                una franela en seco una vez al mes para realzar el brillo de la
                madera.
              </p>
            ...
            {faq.map((f, i) => (
              <details key={i} className="p-6 group open:bg-neutral-50">
                <summary className="cursor-pointer font-semibold flex items-center justify-between list-none">
                  {f.q}
                  <span className="ml-4 text-neutral-400 group-open:rotate-180 transition">
                    ⌄
                  </span>
                </summary>
      ...
      <section id="contacto" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            ...
            subtitle={`Horarios: ${site.horario}`}
          />
                ...
                <p>
                  ...
                  <a
                    ...
                    href={`https://wa.me/${site.phone.replace(
                      /[^\d]/g,
                      ""
                    )}?text=${encodeURIComponent(site.whatsappMsg)}`}
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    {site.phone}
      ...
      <footer className="py-10 border-t bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-sm text-neutral-500">
            ...
            <a
              href={
                site.linkedin || "https://www.linkedin.com/in/luquedavid/"
              }
              target="_blank"
